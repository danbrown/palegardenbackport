...
open class PalmLeavesBlock(pProperties: Properties, private val flammability: Int = 20, private val fireSpread: Int = 5) : FlammableLeavesBlock(pProperties, flammability, fireSpread), SimpleWaterloggedBlock {
