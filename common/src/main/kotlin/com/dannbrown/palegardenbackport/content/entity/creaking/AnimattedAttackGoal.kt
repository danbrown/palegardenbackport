...
class AnimattedAttackGoal(pMob: PathfinderMob, pSpeedModifier: Double, pFollowingTargetEvenIfNotSeen: Boolean) :
  MeleeAttackGoal(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen) {
