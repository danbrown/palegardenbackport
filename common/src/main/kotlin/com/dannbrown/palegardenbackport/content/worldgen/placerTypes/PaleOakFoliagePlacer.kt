...
class PaleOakFoliagePlacer(radius: IntProvider, offset: IntProvider) : DarkOakFoliagePlacer(radius, offset) {
  companion object {
    val CODEC: Codec<DarkOakFoliagePlacer> =
      RecordCodecBuilder.create { p_68473_: RecordCodecBuilder.Instance<DarkOakFoliagePlacer> ->
        foliagePlacerParts(p_68473_).apply(p_68473_) { p_161384_: IntProvider?, p_161385_: IntProvider? ->
  ...
  override fun type(): FoliagePlacerType<*> {
    return ModPlacerTypes.PALE_OAK_FOLIAGE_PLACER.get()
  }
}