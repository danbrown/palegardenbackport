package com.dannbrown.palegardenbackport.content.worldgen.biome

import com.dannbrown.deltaboxlib.registrate.util.AbstractBiome
import com.dannbrown.palegardenbackport.init.ModContent
import com.dannbrown.palegardenbackport.init.ModPlacedFeatures
...
object PaleGardenBiome : AbstractBiome() {
  ...
  override val BIOME_KEY: ResourceKey<Biome> =
    ResourceKey.create(Registries.BIOME, ResourceLocation(ModContent.MOD_ID, biomeId))
